...
describe('no * pattern', () => {
  ...
  it('works with nested conditions', () => {
    ...
    }, '#supports-color', { conditions: ['node', 'import'] })
...
describe(`subpath patterns`, () => {
  ...
  it('maps based on condition', () => {
    ...
    }, '#internal/foo.js', { conditions: ['node', 'default'] })
  ...
  it('maps with nested conditions', () => {
    ...
    }, '#internal/foo.js', { conditions: ['node', 'import'] })
  ...
  it('goes to the next map if first match failed condition checks', () => {
    ...
    }, '#internal/foo/bar.js', { conditions: ['node', 'import'] })
